...
asn_TYPE_member_t asn_MBR_ProfileHeader_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct ProfileHeader, connectivityParameters),
	...
	{ ATF_POINTER, 1, offsetof(struct ProfileHeader, eUICC_Mandatory_AIDs),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		0,
...
static const int asn_MAP_ProfileHeader_oms_1[] = { 2, 4, 7, 8 };
