...
define $(2)_KERNEL_MODULES_BUILD
	@$$(call MESSAGE,"Building kernel modules")
...
define $(2)_KERNEL_MODULES_INSTALL
	@$$(call MESSAGE,"Installing kernel modules")
	$$(foreach d,$$($(2)_MODULE_SUBDIRS), \
		$$(LINUX_MAKE_ENV) $$($$(PKG)_MAKE) \
			-C $$(LINUX_DIR) \
			$$(LINUX_MAKE_FLAGS) \
...
kernel-module = $(call inner-kernel-module,$(call pkgname),$(call UPPERCASE,$(call pkgname)))
