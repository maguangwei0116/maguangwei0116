...
SYSAPP_SYSTEM_NAME=$(call qstrip,$(BR2_CFG_SYSTEM_NAME))
SYSAPP_PRODUCT_NAME=$(call qstrip,$(BR2_CFG_PRODUCT_NAME))
SYSAPP_SOFTWARE_NAME=$(call qstrip,$(BR2_CFG_SOFTWARE_NAME))
SYSAPP_PLATFORM_TYPE=$(call qstrip,$(BR2_CFG_PLATFORM_TYPE))
SYSAPP_SOFTWARE_TYPE=$(call qstrip,$(BR2_CFG_SOFTWARE_TYPE))
SYSAPP_ENV_TYPE=$(call qstrip,$(BR2_CFG_ENV_TYPE))
SYSAPP_CFG_STRIP_strip=$(call qstrip,$(BR2_CFG_STRIP_strip))
SYSAPP_PLATFORM_X86=$(call qstrip,$(BR2_CFG_PLATFORM_X86))
SYSAPP_PLATFORM_9X07=$(call qstrip,$(BR2_CFG_PLATFORM_9X07))
SYSAPP_PLATFORM_ANDROID=$(call qstrip,$(BR2_CFG_PLATFORM_ANDROID))
...
SYSAPP_SUBDIR_ENV=SYSAPP_INSTALL_PATH=$(SYSAPP_INSTALL_PATH) \
		   ...
		   CFG_STRIP_strip=$(SYSAPP_CFG_STRIP_strip) \
		   SYSAPP_ENV_TYPE=$(SYSAPP_ENV_TYPE) \
		   SYSAPP_PLATFORM_X86=$(SYSAPP_PLATFORM_X86) \
		   SYSAPP_PLATFORM_9X07=$(SYSAPP_PLATFORM_9X07) \
		   SYSAPP_PLATFORM_ANDROID=$(SYSAPP_PLATFORM_ANDROID) \
		   SYSAPP_TARGET_OEMAPP_NAME=$(SYSAPP_SYSTEM_NAME)-$(SYSAPP_PRODUCT_NAME)-oemapp-$(SYSAPP_SOFTWARE_NAME)
