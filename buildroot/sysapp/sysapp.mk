...
SYS_SOFTWARE_NAME=$(call qstrip,$(BR2_SOFTWARE_NAME))
SYS_PLATFORM_TYPE=$(call qstrip,$(BR2_PLATFORM_TYPE))
SYS_SOFTWARE_TYPE=$(call qstrip,$(BR2_SOFTWARE_TYPE))
...
SYSAPP_SUBDIR_ENV=SYSAPP_INSTALL_PATH=$(SYSAPP_INSTALL_PATH) \
		   ...
		   SYS_SOFTWARE_NAME=$(SYS_SOFTWARE_NAME) \
		   PLATFORM_TYPE=$(SYS_PLATFORM_TYPE) \
		   DEBUG_TYPE=$(SYS_SOFTWARE_TYPE) \
		   SYSROOT=$(TARGET_SYSROOT) \
		   SYSAPP_GIT_HASH=$(SYSAPP_GIT_HASH) \
		   SYSAPP_KCONFIG_AUTOHEADER=$(KCONFIG_AUTOHEADER_FILE)
