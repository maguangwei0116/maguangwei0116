...
LIBRARY_SYSTEM_NAME=$(call qstrip,$(BR2_CFG_SYSTEM_NAME))
LIBRARY_PRODUCT_NAME=$(call qstrip,$(BR2_CFG_PRODUCT_NAME))
LIBRARY_SOFTWARE_NAME=$(call qstrip,$(BR2_CFG_SOFTWARE_NAME))
LIBRARY_PLATFORM_TYPE=$(call qstrip,$(BR2_CFG_PLATFORM_TYPE))
LIBRARY_SOFTWARE_TYPE=$(call qstrip,$(BR2_CFG_SOFTWARE_TYPE))
