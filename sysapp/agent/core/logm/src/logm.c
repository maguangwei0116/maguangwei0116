...
static int32_t downstream_log_parser(const void *in, char *tranId, void **out)
{
    int32_t ret;
    cJSON *msg = NULL;
    cJSON *tran_id = NULL;
...
DOWNSTREAM_METHOD_OBJ_INIT(LOG, MSG_ID_IDLE, ON_LOG, downstream_log_parser, downstream_log_handler);
